-- 2026-09-25 In Odyssey 4장 「홍해를 건너다」: 장 완료 달란트를 4장까지 받을 수 있게(계정당 장마다 한 번 20달란트).
...
begin
  ...
  if p_ch < 1 or p_ch > 4 then raise exception '아직 없는 장이에요.'; end if;   -- 새 장을 열 때 최댓값을 올린다
...
$function$;
select 'ok — odyssey ch4' as status;
