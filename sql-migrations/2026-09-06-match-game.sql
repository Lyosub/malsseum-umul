...
-- book_game 과 동일한 기록/달란트 구조. 모드: easy(8쌍) / hard(16쌍), 모드별 따로 랭킹.
--
-- ⚠️ points_ledger CHECK 제약에 match_game_easy / match_game_hard 를 미리 넣는다
...
select 'match_game_scores 테이블/함수 + points_ledger CHECK(match_game_*) 갱신 완료' as status;
